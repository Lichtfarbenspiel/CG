        ...
        public override void RenderAFrame()
        {
            ...
            if (Mouse.LeftButton)
            {
                ...
                if (newPick?.Node != _currentPick?.Node)
                {
                    ...
                    //     rotateComponent += DeltaTime * Keyboard.WSAxis;
                    //     rotateComponent.Rotation =  new float3(rotateComponent, 0, 0);
                    }
                    if (newPick != null)
                    {
...
// float currentPickRot = _currentPick.Node.GetComponent<TransformComponent>().Rotation.x;
                        // currentPickRot -= 0.01f * Keyboard.WSAxis;
                        // _currentPick.Node.GetComponent<TransformComponent>().Rotation = new float3(currentPickRot, 0, 0);