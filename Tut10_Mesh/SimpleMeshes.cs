    ...
    public static class SimpleMeshes 
    {
       ...
       public static ShaderEffect MakeShaderEffect(float3 diffuseColor, float3 specularColor, float shininess)
        ...
        public static Mesh CreateCylinder(float radius, float height, int segments)
        {
            ...
            // mesh.Vertices[0]= new float3(20, 0, 0);
            // mesh.Vertices[1]= new float3(10, 0, 17.32f);
            // mesh.Vertices[2]= new float3(-10, 0, 17.32f);
            // mesh.Vertices[3]= new float3(-20, 0, 0);
            // mesh.Vertices[4]= new float3(-10, 0, -17.32f);
            // mesh.Vertices[5]= new float3(10, 0, -17.32f);
            // mesh.Vertices[6]= new float3(0, 0, 0);

            // mesh.Normals[0] = new float3(0, 1, 0);
            // mesh.Normals[1] = new float3(0, 1, 0);
            // mesh.Normals[2] = new float3(0, 1, 0);
            // mesh.Normals[3] = new float3(0, 1, 0);
            // mesh.Normals[4] = new float3(0, 1, 0);
            // mesh.Normals[5] = new float3(0, 1, 0);
            // mesh.Normals[6] = new float3(0, 1, 0);

            // mesh.Triangles = new ushort[18];
            // mesh.Triangles[0] = 6;
            // mesh.Triangles[1] = 0;
            // mesh.Triangles[2] = 1;
            // mesh.Triangles[3] = 6;
